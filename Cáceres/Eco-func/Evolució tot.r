...
setwd('/Users/marceloppisuner/Documents/GitHub/Diputacions/Cáceres/Eco-func')
...
png_files <- list.files(path = getwd(), pattern = "^cac_ef_plot_.*\\.png$", full.names = FALSE)
plotFiles_js <- paste0(
  "const plotFiles = [",
