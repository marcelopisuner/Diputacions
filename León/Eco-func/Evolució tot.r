...
setwd('/Users/marceloppisuner/Documents/GitHub/Diputacions/León/Eco-func')
...
png_files <- list.files(path = getwd(), pattern = "^leon_ef_plot_.*\\.png$", full.names = FALSE)
plotFiles_js <- paste0(
  "const plotFiles = [",
