...
setwd('/Users/marceloppisuner/Documents/GitHub/Diputacions/València/Eco-func')
...
png_files <- list.files(path = getwd(), pattern = "^val_ef_plot_.*\\.png$", full.names = FALSE)
plotFiles_js <- paste0(
  "const plotFiles = [",
