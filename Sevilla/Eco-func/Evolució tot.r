...
setwd('/Users/marceloppisuner/Documents/GitHub/Diputacions/Sevilla/Eco-func')
...
png_files <- list.files(path = getwd(), pattern = "^sev_ef_plot_.*\\.png$", full.names = FALSE)
plotFiles_js <- paste0(
  "const plotFiles = [",
